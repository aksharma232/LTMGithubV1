...
//====================================================================
	...
	@FindBy(how=How.ID, using="LXSoftwareUpgrade_fileUpload")
	WebElement Upgrade_Patch_Location;
	
	public WebElement Upgrade_Patch_Location()
	{
		return Upgrade_Patch_Location;
	}


// Cancel Button ==========================	

	@FindBy(how=How.ID, using="LXSoftwareUpgrade_btnInstallSW") 
...
//Close Button =================================
	...
	@FindBy(how=How.XPATH, using="//a[@href='javascript:ClosedUC();']") 
